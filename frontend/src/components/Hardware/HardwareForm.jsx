...
const HardwareForm = ({ onHardwareCreated, editingHardware, userRole }) => {
    ...
    const options = {
        ...
        printerBrands: ['HP', 'Epson', 'Brother', 'Canon', 'Xerox', 'Lexmark', 'Kyocera', 'Ricoh', 'Samsung', 'Konica Minolta', 'Sharp', 'OKI'],
        projectorBrands: ['Epson', 'BenQ', 'Optoma', 'Sony', 'Panasonic', 'ViewSonic', 'NEC', 'LG', 'InFocus', 'Vivitek', 'Christie', 'Hitachi'],
        monitorBrands: ['Dell', 'LG', 'Samsung', 'ASUS', 'Acer', 'BenQ', 'ViewSonic', 'AOC', 'Philips', 'HP', 'MSI', 'Gigabyte', 'Alienware'],
        networkBrands: ['Cisco', 'D-Link', 'Netgear', 'Ubiquiti', 'TP-Link', 'Huawei', 'Aruba', 'Juniper', 'MikroTik', 'HPE'],
        ...
        pcModels: ['OptiPlex 7000', 'OptiPlex 5000', 'OptiPlex 3000', 'Precision 5820', 'Precision 7920', 'PowerEdge T340', 'PowerEdge R640', 'ThinkCentre M70', 'ThinkCentre M90', 'ProDesk', 'EliteDesk', 'Z2', 'Z4', 'Z6', 'Z8', 'Aspire TC', 'Predator Orion'],
        laptopModels: ['Latitude 7420', 'Latitude 5430', 'Latitude 3420', 'EliteBook 840', 'EliteBook 640', 'ProBook 440', 'ZBook Power', 'ThinkPad T14', 'ThinkPad T16', 'ThinkPad X1', 'Vivobook Pro', 'Zenbook', 'ROG Zephyrus', 'TUF Gaming', 'Predator Helios', 'Swift', 'Aspire', 'Pavilion', 'Envy', 'Spectre', 'Omen', 'MacBook Air', 'MacBook Pro'],
        printerModels: ['LaserJet Pro M404', 'LaserJet Pro M15w', 'OfficeJet Pro 9015', 'DeskJet 2720', 'EcoTank L3250', 'EcoTank L5290', 'WorkForce Pro WF-3820', 'imageCLASS MF743Cdw', 'PIXMA G3110', 'HL-L2350DW', 'MFC-L2750DW', 'Phaser 3260', 'WorkCentre 6515', 'Bizhub C3350'],
        projectorModels: ['EB-X05', 'EB-U05', 'PowerLite 1795F', 'MW632ST', 'MX825ST', 'HD146X', 'EH-TW650', 'VPL-EX455', 'PT-LB426', 'PA503W', 'PJD5155'],
        monitorModels: ['UltraSharp U2422H', 'S2721QS', '27UL500', '24MP400', 'VA24EHE', 'ProLite XU2493HS', 'C27F396', 'ViewSonic VA24', 'GL2480', 'AOC 24B2XH'],
        switchModels: ['Catalyst 2960', 'Catalyst 9200', 'DGS-1100-08', 'GS308', 'UniFi Switch 8-60W', 'TL-SG108', 'S5700'],
        routerModels: ['ISR 4321', 'RV340', 'Nighthawk R7000', 'UniFi Dream Machine', 'Archer C7', 'MikroTik hEX', 'ASR1001-X']
    };
    ...
    const getBrandOptions = () => {
        switch (formData.device_type) {
            case 'Impresora': return options.printerBrands;
            case 'Videobeam': return options.projectorBrands;
            case 'Monitor': return options.monitorBrands;
            case 'Switch':
            case 'Router': return options.networkBrands;
            default: return options.brands;
        }
    };
 
    const getModelOptions = () => {
        switch (formData.device_type) {
            case 'PC': return options.pcModels;
            case 'Laptop': return options.laptopModels;
            case 'Impresora': return options.printerModels;
            case 'Videobeam': return options.projectorModels;
            case 'Monitor': return options.monitorModels;
            case 'Switch': return options.switchModels;
            case 'Router': return options.routerModels;
            default: return options.laptopModels;
        }
    };
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div style={{ padding: '16px', background: '#f8f9fa', borderRadius: '8px', border: '1px solid #e0e0e0', marginBottom: '20px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '12px' }}>
                        ...
                        {renderSelect('Marca', 'brand', formData.brand, getBrandOptions())}
                        {renderSelect('Modelo', 'model', formData.model, getModelOptions())}
                        {renderDateInput('Fecha de Compra', 'purchase_date', formData.purchase_date, undefined, getTodayLocal())}
